...
doc.corpus <- tm_map(doc.corpus, removeWords, c("somosfeder","diamundialenfermedadesraras"))   
...
# add title
title("\nTweets with '#somosfeder"or"#diamundialenfermedadesrarasFeder':  Who retweets whom",
